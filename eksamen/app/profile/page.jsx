...
//    console.log("user:", user);
    ...
    if (user.role === "default") {
        // vis medlem-UI
        return (
            <section className='flex flex-col mb-10 pb-10'>
                ...
                <section className='mx-4'>
                    {user.classes.map(workoutClass => (
                            <article className='my-6 bg-white/80 px-4 py-6 text-black rounded-3xl border border-[#9E9E9E]'
                                key={workoutClass.id}>
                                <h3 className='text-2xl pb-2 font-[500]'>{workoutClass.className}</h3>
                                ...
                                <div className='flex justify-between'>
                                    ...
                                    href={`classes/${workoutClass.id}`}>Show Class</Link>
